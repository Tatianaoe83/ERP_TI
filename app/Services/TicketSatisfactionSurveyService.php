...
class TicketSatisfactionSurveyService
{
    ...
    public function sendSurveyForClosedTicket(Tickets $ticket): ?Calificacion
    {
        ...
        try {
            Mail::to($correo)->send(new TicketSatisfactionSurveyMail($ticket, $survey, $resolution));
            ...
            Log::error("Error enviando encuesta del ticket #{$ticket->TicketID}: " . $e->getMessage());
        }
