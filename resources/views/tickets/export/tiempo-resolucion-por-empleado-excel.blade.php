<table>
    <tr>
        <td colspan="7" style="background-color: #1E3A8A; color: #FFFFFF; font-size: 18px; font-weight: bold; text-align: center; padding: 20px; border: 2px solid #1E40AF;">
            TIEMPO DE RESOLUCIÓN POR EMPLEADO - AGRUPADO POR RESPONSABLE
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <th style="background-color: #4472C4; color: #FFFFFF; font-weight: bold; padding: 12px; border: 1px solid #1E40AF; text-align: center;">Empleado</th>
    ...
    <tr style="{{ $index % 2 == 0 ? 'background-color: #FFFFFF;' : 'background-color: #F9FAFB;' }}">
        <td style="padding: 10px; border: 1px solid #E5E7EB; text-align: left; font-weight: bold; color: #1E40AF;">{{ $dato['responsable'] }}</td>
        <td style="padding: 10px; border: 1px solid #E5E7EB; text-align: left;">{{ $dato['empleado'] }}</td>
    ...
    @empty
    <tr>
        <td colspan="7" style="padding: 20px; text-align: center; color: #9CA3AF; font-style: italic;">
