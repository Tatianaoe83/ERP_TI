...
<div
    ...
    <div
        ...
        <div
            class="rounded-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col border  dark:bg-[#1C1F26] border-gray-200 dark:border-[#2A2F3A]"
            @click.stop>
            <!-- Header del Modal -->
            ...
            <!-- Contenido del Modal -->
            <div class="flex-1 overflow-y-auto p-6  dark:bg-[#1C1F26]">
                <!-- Bloque informativo -->
                        ...
                        <tbody class=" dark:bg-[#1C1F26]">
                            ...
                            <template x-if="!cargandoMetricas && metricasTipos && metricasTipos.length > 0">
                                <template x-for="(tipo, index) in metricasTipos" :key="tipo.TipoID">
                                    <tr class="transition dark:bg-[#1F2937] border-b border-gray-200 dark:border-b dark:border-[#2A2F3A] hover:bg-gray-50 dark:hover:bg-[#273244]">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <input
                                                ...
                                                placeholder="0"
                                                class="w-32 px-3 py-2 rounded-md text-sm border dark:bg-[#0F1115] border-gray-300 dark:border-[#2A2F3A] text-gray-900 dark:text-[#E5E7EB] placeholder-gray-400 dark:placeholder-[#6B7280] focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition">
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">
