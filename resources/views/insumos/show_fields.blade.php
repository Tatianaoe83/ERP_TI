    ...
    <div class="card mt-3">
        <div class="card-header">
            <h6 class="card-title mb-0 text-[#101D49] dark:text-white">
                <i class="fas fa-calculator me-2"></i>Costos con IVA Aplicado
            </h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6">
                    <label class="text-[#101D49] dark:text-white">Costo Mensual con IVA:</label>
                ...
                <div class="col-sm-6">
                    <label class="text-[#101D49] dark:text-white">Costo Anual con IVA:</label>
                    <div class="input-group">
                        <span class="input-group-text">$</span>
